  ...
  return (
    <div className="rounded-[12px] p-3 md:p-4 border border-neutral-100 space-y-3">
      ...
      <div className="border border-neutral-100 p-5 rounded-t-[10px]">
        <h3 className="text-neutral-850 font-medium text-lg mb-3.75">
          جزئیات پرداخت
        </h3>
        <div className="space-y-3.75 [&>div:last-child]:mt-7.5">
      ...
      <div className="flex *:cursor-pointer items-center gap-x-2">
        ...
        />
        <Label htmlFor="payment-terms" className="text-neutral-850 text-xs">
      ...
      <Button
        ...
        className="w-full cursor-pointer h-12.25 rounded-xl bg-primary-500 hover:bg-primary-600 disabled:bg-primary-300 disabled:cursor-not-allowed text-white text-base font-medium flex items-center justify-center gap-x-2 transition-colors"
      >
        پرداخت
