        ...
        <div className="xs:p-3">
          <div className="flex xs:flex-row flex-col">
            ...
            <Image
              ...
              height={153}
              alt={doctorData.name}
              className="xs:rounded-tr-[6px] min-h-full w-full xs:w-[186px] sm:aspect-186/153 object-cover xs:rounded-br-[6px]"
              priority
            />
          ...
          <div className="flex flex-col gap-y-3 sm:gap-y-[7px] md:px-1 px-3 xs:px-0 sm:px-0 pb-3 xs:pb-0 mt-[7px]">
            ...
            <div className="flex items-center gap-x-2 sm:gap-x-4">
              ...
              <span className="font-medium text-sm text-neutral-600">
                اولین نوبت در دسترس:{' '}
                <span className="text-neutral-950">{doctorData.nextAvailableSlot}</span>
              </span>
            </div>
          </div>
        </div>
