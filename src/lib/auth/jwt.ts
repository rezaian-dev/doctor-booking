...
/**
 * ♻️ Issues a long-lived refresh token (7d) containing the user ID **and role**.
 * Embedding the role lets the edge proxy mint a new access token on refresh
 * WITHOUT a DB read — keeping the proxy free of Mongoose (Edge-safe). 🌐
 */
