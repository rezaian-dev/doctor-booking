...
const ArticlesGrid: FC = () => {
  ...
  return (
     <section className="container px-4 md:px-8 mt-6 md:mt-[92px]">
      {/* 🏷️ Section heading */}
      <h1 className="text-neutral-975 font-medium text-lg md:text-2xl">آخرین مقالات</h1>

      {/* 🧱 Responsive article grid */}
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-[18px] mt-[18px] pb-[18px] border-b border-neutral-100">
