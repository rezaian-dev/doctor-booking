  ...
  return (
    ...
    <section
      className={clsx(
        ...
        {
          'mt-7.5 md:mt-[94px]': mode === 'preview', // ⏫ Spacing only on homepage/preview
        },
        className
      )}
    >
      ...
      {mode ==="full" && <div className='absolute top-24 left-12 md:left-64 m-auto w-[182px] h-max md:w-max md:h-max -z-1 pointer-events-none'>
