...
const SearchHero = ({mode}:SearchHeroParams) => {
  ...
  mode === 'find-doctor'
    ...
    : 'container px-4 md:px-8 mt-3.5 md:mt-7.5'
)}>
  ...
  {
    'h-65 md:h-107 rounded-2xl md:rounded-none bg-[linear-gradient(rgba(17,17,17,0.1),rgba(17,17,17,0.1)),url(/images/Search-box.png)]':
      mode === 'find-doctor',
    'h-75 rounded-2xl bg-[linear-gradient(rgba(17,17,17,0.4),rgba(17,17,17,0.4)),url(/images/Search-box.png)]':
      mode !== 'find-doctor',
  }
)}
      >
