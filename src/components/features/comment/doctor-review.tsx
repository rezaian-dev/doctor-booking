...
import DoctorHeader from '@/components/features/comment/doctor-header';
import StarRatingInput from '@/components/features/comment/star-rating-input';
import { Label } from '@/components/ui/label';
import RecommendButton from '@/components/features/comment/recommend-button';
